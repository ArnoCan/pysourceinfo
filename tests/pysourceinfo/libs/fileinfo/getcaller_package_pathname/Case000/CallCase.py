...
class CallUnits(unittest.TestCase):
    def testcase000(self):
        ...
        fpn = os.path.abspath(os.path.normpath(
            os.path.dirname(sourceinfo.__file__) + "/.."))
        fx = fileinfo_check_tests.check_callback(
            sourceinfo.fileinfo.getcaller_package_pathname, 0)
    ...
    def testcase001(self):
        ...
        import fileinfo_check_tests  # @UnresolvedImport
        fx = fileinfo_check_tests.check_callback(
            sourceinfo.fileinfo.getcaller_package_pathname, 2)
    ...
    def testcase003(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            sourceinfo.fileinfo.getcaller_package_pathname, 3)
