...
class CallUnits(unittest.TestCase):
    ...
    def testcase020(self):
        ...
        resx = 'fileA.py'
        res = getpythonpath_rel('fileA.py', presolve=P_LONGEST)
    ...
    def testcase030(self):
        ...
        resx = 'x0/fileA.py'
        res = getpythonpath_rel('x0/fileA.py', presolve=P_LONGEST)
        self.assertEqual(res, resx)
    ...
    def testcase040(self):
        ...
        resx = 'a2/x1/fileA.py'
        res = getpythonpath_rel('a2/x1/fileA.py', presolve=P_LONGEST)
        self.assertEqual(res, resx)
