...
class CallUnits(unittest.TestCase):
    def testcase000(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_pathname, 0)
    ...
    def testcase001(self):
        ...
        fx0 = pysourceinfo.fileinfo.getmodule_pathname(fileinfo_check_tests)
        fx1 = pysourceinfo.fileinfo.getmodule_pathname(pysourceinfo)

        fx0 = os.path.abspath(fx0)
        fx1 = os.path.abspath(fx1)

        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_pathname, 1)
    ...
    def testcase002(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_pathname, 2)
        fx = os.path.normpath(fx)
        assert fx == fpn
    ...
    def testcase003(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_pathname, 3)
