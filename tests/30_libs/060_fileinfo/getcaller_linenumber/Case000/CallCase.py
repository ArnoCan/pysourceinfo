...
class CallUnits(unittest.TestCase):
    def testcase000(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_linenumber, 0)
    ...
    def testcase001(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_linenumber, 1)
    ...
    def testcase002(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_linenumber, 2)

        sys.path.pop(0)

        self.assertEqual(fx, 54)
        assert sys.path == _s
    ...
    def testcase003(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_linenumber, 3)
