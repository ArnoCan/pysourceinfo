...
class CallUnits(unittest.TestCase):
    def testcase000(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_filename, 0)
    ...
    def testcase001(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_filename, 1)
    ...
    def testcase002(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_filename, 2)
    ...
    def testcase003(self):
        ...
        fx = fileinfo_check_tests.check_callback(
            pysourceinfo.fileinfo.getcaller_filename, 3)
