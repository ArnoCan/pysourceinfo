...
class CallUnits(unittest.TestCase):
    ...
    def testcase002(self):
        ...
        fx = PySourceInfo_check.check_callback(pysourceinfo.objectinfo.getcaller_module_name,2)
    ...
    def testcase003(self):
        ...
        fx = PySourceInfo_check.check_callback(pysourceinfo.objectinfo.getcaller_module_name,3)
