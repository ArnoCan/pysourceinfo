...
class CallUnits(unittest.TestCase):
    def testcase000(self):
        ...
        fpn = sourceinfo.fileinfo.getmodule_filepathname(sourceinfo)
        fpn =os.path.dirname(fpn)
        fx = fileinfo_check_usecases.check_callback(sourceinfo.fileinfo.getcaller_package_filepathname,0)
    ...
    def testcase001(self):
        ...
        fx = fileinfo_check_usecases.check_callback(sourceinfo.fileinfo.getcaller_package_filepathname,1)
    ...
    def testcase002(self):
        ...
        res  = fileinfo_check_usecases.check_callback(sourceinfo.fileinfo.getcaller_package_filepathname,2)
