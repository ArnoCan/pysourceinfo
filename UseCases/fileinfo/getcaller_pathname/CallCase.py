...
class CallUnits(unittest.TestCase):
    ...
    def testcase002(self):
        ...
        fx = fileinfo_check_usecases.check_callback(pysourceinfo.fileinfo.getcaller_pathname,2)
    ...
    def testcase003(self):
        ...
        fx = fileinfo_check_usecases.check_callback(pysourceinfo.fileinfo.getcaller_pathname,3)
